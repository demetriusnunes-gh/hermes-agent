# Cron Job: Email checker - relevant alerts (FAILED)

**Job ID:** ef8ac0a9a456
**Run Time:** 2026-04-04 00:58:51
**Schedule:** every 120m
...
Traceback (most recent call last):
  File "/root/.hermes/hermes-agent/cron/scheduler.py", line 455, in run_job
    result = _cron_future.result(timeout=_cron_timeout)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/root/.local/share/uv/python/cpython-3.11.15-linux-x86_64-gnu/lib/python3.11/concurrent/futures/_base.py", line 458, in result
    raise TimeoutError()
TimeoutError
...
Traceback (most recent call last):
  File "/root/.hermes/hermes-agent/cron/scheduler.py", line 464, in run_job
    raise TimeoutError(
TimeoutError: Cron job 'Email checker - relevant alerts' timed out after 10 minutes
