...
- Treat sports/news digests, vehicle/loan discount promos, mileage coupon campaigns, generic travel upsell campaigns, and medical/check-up marketing invitations as irrelevant even when they contain superficially actionable words like `boleto`, `débito`, `cupom`, `viagem`, `prevenção`, or a user name. Require concrete transaction evidence: confirmed booking/order, shipment, payment, appointment created/changed/cancelled, bill due, security alert, or an explicit required action.
